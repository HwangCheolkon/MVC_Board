			...
			<table width="1100" border="1">
				<form name="modify_form" action="modify.do" method="post">
					...
					<tr>
						...
						<td><input type="text" name="bTitle" size="140" value="${content_view.bTitle }"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
						<textarea name="bContent" id="bContent">${content_view.bContent }</textarea>
					...
					<tr>
						<td colspan="2" height="40">
							...
							<a href="content_view.do?bId=${content_view.bId }" class="btn btn-secondary" style="padding:2px 10px">취소</a>&nbsp;
