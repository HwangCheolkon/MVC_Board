...
<div class="container">
    <div class="row">
	    ...
	    <div class="col test1 align-self-center"><br>
	    	<h1>회원정보 수정</h1><br>
			<form action="modifyOk.doU" method="post" name="reg_frm">
			아이디<br><input type="text" size="25" value="<%= dto.getId() %>"><br><br>		
			...
			본인 확인 이메일<br><input type="text" name="eMail" size="25" value="<%= dto.geteMail() %>"><br><br>
			주소<br><input type="text" name="address" size="50" value="<%= dto.getAddress() %>"><br><br>
			<input type="button" class="btn btn-outline-primary" value="수정" onclick="updateInfoConfirm()">&nbsp;&nbsp;
