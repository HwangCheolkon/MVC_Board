...
<div class="container">
    <div class="row">    
	    <div class="col" style="text-align:center;"><br>
	    	<h1>회원 탈퇴</h1><br>
			<p><h5><%=id %> 님<br>탈퇴하시려면 아이디와 비밀번호를 입력해 주세요.</h5></p>
			<form action="leaveOk.doU" method="post" name="reg_frm">
				아이디<br><input type="text" name="uid" size="25"><br><br>
				비밀번호<br><input type="password" name="pw" size="25"><br><br>
				비밀번호 확인<br><input type="password" name="pw_check" size="25"><br><br>
				<input type="button" class="btn btn-outline-primary" value="탈퇴하기" onclick="leaveConfirm()">&nbsp;&nbsp;
				<input type="button" class="btn btn-outline-primary" value="돌아가기" onclick="javascript:window.location='myInfoPage.jsp'">
	    	</form><br>
...
function leaveConfirm() {	
	if(document.reg_frm.uid.value == "") {
		alert("아이디를 입력하세요.");
		document.reg_frm.uid.focus();
		return;
	}
